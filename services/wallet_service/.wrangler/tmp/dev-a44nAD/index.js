  ...
  async fetch(req, env) {
    ...
    try {
      ...
      if (path === "/pay/service-charge" && method === "POST") {
        ...
        `).bind(order_id).first();
        if (existing) {
          const adminUpi = env.ADMIN_UPI_ID || "pay@bgmimarket";
          return json({
...
// C:/Users/lkush/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// .wrangler/tmp/bundle-JQKGTo/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default
];
var middleware_insertion_facade_default = index_default;

// C:/Users/lkush/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-JQKGTo/middleware-loader.entry.ts
